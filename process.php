...
$your_email = "niconijland@gmail.com"; // email address to which the form data will be sent
...
<title>Error</title>
<style>
	body {background: #eee; font: 100%/1.375 Raleway, sans-serif;padding: 20px 40px;}
